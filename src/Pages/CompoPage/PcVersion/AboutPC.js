...
const About = () => {
  ...
  const handleMouseLeave = () => {
    setIsHovered(false);  // Remove the hover effect
  };
    ...
    id="aboutPC">
      ...
      <div className="row">
        ...
        <motion.div
            ...
            animate="show"
        >
          <h3 style={{fontFamily: "'Great Vibes', cursive", color: '#ffffff', fontSize: '4.6rem'}}>I'm Ujjwal Saini</h3>
          <span style={{
        ...
        >
          ...
          <div className="box-container">
            ...
            <div className="box">
              ...
              <span  style={{color: '#ff00ff', fontFamily: "'Vidaloka', serif", fontWeight: 500, marginTop: '1rem'}}> Degree : </span> BTech- IT'26</p>
              </motion.div>
...
// Todo: Previous Code As it is, just for reference and for safety
